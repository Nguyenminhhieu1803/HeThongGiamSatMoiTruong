...
\begin{titlepage}
	...
	\begin{center}
		...
		\includegraphics[width=0.25\textwidth]{Logo/Logo_HUS_notext} % Logo cho bìa phụ
		...
		% Sử dụng tabular để căn chỉnh các dòng thông tin chi tiết (Giống hệt main-cover.tex)
